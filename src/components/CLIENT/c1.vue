...
<!-- content -->
 <div class="vcontent">
   ...
   <div style="font-size:20px;font-weight:bold">{{vtitle}}——原来是诈骗</div>
...
margin-top:-3px;">获赞数：{{goodjob2+1}}</div>
<div style="color:transparent">"</div>
   </div>
   </div>
 ...
 @click="ptab(pindex)" v-for="(item ,pindex) in dataList"
  ...
  <div  v-show="pnumber == 0">
    ...
    <el-collapse  v-model="activeName" accordion >
           <el-collapse-item  title="主目录"  name="1">
      <div class="collitem">
      <img class="vrconlimg"  @click="tomainvideo()"
      src='../../static/picture/bofang.png' alt=""/>
   <span style="font-size:18px; 
   position:relative;
  left:18px;
  top:1px;cursor:pointer">反对电信诈骗</span>
    </div>
      </el-collapse-item>
...
let videoshow=ref("http://nicklorry.top:8090/oss/getVideo?id=video/yls.mp4")
