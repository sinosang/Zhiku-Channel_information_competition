...
<div class="brconl">
  ...
  <div class="brconr" v-show="number == 1">
  <img style="width:40px;height:40px;" src='../../static/picture/warning.png' alt=""/> 
   <p style="color:black">您还没有收藏过课程哟，快去找些感兴趣的课程吧</p>
  </div>
</div>
  </div>
...
const wrsearch=ref('')
let per1end=183
 let per1=Math.round(1/per1end*100.0)
 let per2=74
 let per3=32
    let carouseData=[
         {url:(banner4)},
